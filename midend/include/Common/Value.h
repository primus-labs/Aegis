...
template <typename T> struct Tensor {
  ...
  /// Creates a tensor with the shape described by input dims, default filled
  /// with zeros.
...
struct Value {
  ...
  std::variant<Tensor<uint8_t>, Tensor<int8_t>, Tensor<uint16_t>,
               ...
               Tensor<uint64_t>, Tensor<int64_t>, Tensor<float>, Tensor<double>>
      data;
  ...
  template <typename T> bool hasDataType() const {
