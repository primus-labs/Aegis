...
// CHECK: (%[[ARG0:[a-zA-Z0-9_]+]]: !fhe.lwecipher<f32> {onnx.name = "input_x", onnx.type = "encrypted"}, %[[ARG1:[a-zA-Z0-9_]+]]: !fhe.lwecipher<f32> {onnx.name = "input_y", onnx.type = "encrypted"}) -> !fhe.lwecipher<f32>
