...
RLWECipher main_graph(RLWECipher v1, RLWECipher v2) {
  RLWECipher v3 = Rotate(v1, -11);
  RLWECipher v4 = Rotate(v1, -15);
  RLWECipher v5 = Rotate(v1, -3);
  RLWECipher v6 = Rotate(v1, -12);
  RLWECipher v7 = Rotate(v1, -4);
  RLWECipher v8 = Rotate(v1, -13);
  RLWECipher v9 = Rotate(v1, -5);
  RLWECipher v10 = Rotate(v1, -1);
  RLWECipher v11 = Add(v3, v4, v5, v6, v1, v7, v8, v9, v10);
  Copy(v11, v2);
  return v2;
}
