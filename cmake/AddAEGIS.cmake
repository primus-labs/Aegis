...
# *********************************************************************
# Set up LLVM/MLIR if no -DMLIR_DIR is provided
...
# **********************************************************************
# Custom TableGen helper for Aegis Dialects
# **********************************************************************
function(add_aegis_dialect dialect dialect_namespace)
  add_custom_target(Aegis${dialect}IncGen)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${dialect}Ops.td")
    ...
    add_public_tablegen_target(Aegis${dialect}OpsIncGen)
    add_dependencies(Aegis${dialect}IncGen Aegis${dialect}OpsIncGen)
  endif()
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${dialect}Types.td")
    ...
    add_public_tablegen_target(Aegis${dialect}TypesIncGen)
    add_dependencies(Aegis${dialect}IncGen Aegis${dialect}TypesIncGen)
  endif()
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${dialect}Attributes.td")
    ...
    add_public_tablegen_target(Aegis${dialect}AttributesIncGen)
    add_dependencies(Aegis${dialect}IncGen Aegis${dialect}AttributesIncGen)
  endif()
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${dialect}Enums.td")
    ...
    add_public_tablegen_target(Aegis${dialect}EnumsIncGen)
    add_dependencies(Aegis${dialect}IncGen Aegis${dialect}EnumsIncGen)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${dialect}TypeInterfaces.td")
    ...
    add_public_tablegen_target(Aegis${dialect}TypeInterfacesIncGen)
    add_dependencies(Aegis${dialect}IncGen Aegis${dialect}TypeInterfacesIncGen)
  endif()
endfunction()


# **********************************************************************
# Custom TableGen helper for Aegis Pass
# call add_aegis_pass(passName) for normal use
# call add_aegis_pass(passName PATTERNS) to generate rewriter patterns
# **********************************************************************
function(add_aegis_pass pass)
